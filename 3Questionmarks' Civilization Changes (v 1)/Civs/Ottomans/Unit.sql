...
VALUES  ('UNIT_4_OTTOMAN_CANON',  'RESOURCE_IRON', 1);
--------------------------------	
-- Unit_FreePromotions
--------------------------------	
...
VALUES	('UNIT_4_OTTOMAN_CANON',  'PROMOTION_SIEGE_3UC'),
		('UNIT_4_OTTOMAN_CANON',  'PROMOTION_INDIRECT_FIRE');
