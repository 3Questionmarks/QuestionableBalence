...
INSERT INTO DecisionsAddin_Support (FileName) VALUES ('DMS_Ireland_OConnell_Decisions.lua');
------------------------------
-- Policies
------------------------------	
INSERT INTO Policies	
		(Type,									Description)
VALUES	('POLICY_DMS_GAELIC_REVIVAL',			'TXT_KEY_POLICY_DMS_GAELIC_REVIVAL');
------------------------------
-- Policy_GreatWorkYieldChanges
------------------------------
INSERT INTO Policy_GreatWorkYieldChanges
		(PolicyType,							YieldType,			Yield)
VALUES	('POLICY_DMS_GAELIC_REVIVAL',			'YIELD_CULTURE',	1);
--==========================================================================================================================
-- Hazel's Map Labels
--==========================================================================================================================
-- ML_CivCultures
...
SELECT	('CIVILIZATION_DMS_IRELAND_OCONNELL'),	CultureType,	CultureEra
...
WHERE Type = 'CIVILIZATION_DMS_IRELAND_OCONNELL'
...
VALUES	('CIVILIZATION_DMS_IRELAND_OCONNELL',	'Cordiform',		20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'GreatestEarth',	20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'EuroLarge',		20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'Yagem',			20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'Yahem',			20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'BritishIsles',		20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'EuroGiant',		20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'NorthAtlantic',	20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'NorthWestEurope',	20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'EuroLargeNew',		20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'NorthSeaEurope',	20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'ScotlandIrelandHuge',20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'AtlanticGiant',	20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'EarthMk3',			20,	80),
		('CIVILIZATION_DMS_IRELAND_OCONNELL',	'NorthSeaGiant',	20,	80);
--------------------------------------------------------------------------------------------------------------------------
...
SELECT	'CIVILIZATION_DMS_IRELAND_OCONNELL', MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
INSERT INTO JFD_Civilopedia_HideFromPedia
		(Type)
VALUES	('POLICY_DMS_GAELIC_REVIVAL'),
		('BUILDING_DMS_PRESSURE_FROM_GREATWORKS'),
		('BUILDING_DMS_CULTURE_FROM_PRESSURE'),
		('BUILDING_DMS_UNIT_PRODUCTION_FROM_PRESSURE');
...
VALUES	('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_DECOLONIZATION',		 4),
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_MERCENARY',				 3),
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	 2),
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_REFORM_GOVERNMENT',		 4), --Scale of Liberal to Authoritarian.
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_REFORM_LEGAL',			 5), 	
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_REFORM_CULTURE',		 3),
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_REFORM_ECONOMIC',		 5),
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_REFORM_EDUCATION',	 	 6),
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_REFORM_FOREIGN',		 5),
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_REFORM_INDUSTRY',		 3),
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_REFORM_MILITARY',		 4),
		('LEADER_DMS_DANIEL_O_CONNELL',	'FLAVOR_JFD_REFORM_RELIGION',		 4),
...
SELECT	'CIVILIZATION_DMS_IRELAND_OCONNELL',	ArtDefineTag, CultureType, SubCultureType, DecisionsTag, IdealsTag, SplashScreenTag, SoundtrackTag, UnitDialogueTag
