...
SELECT 'IMPROVEMENT_PLANT_FOREST',	1,						1,				'TXT_KEY_IMPROVEMENT_PLANT_FOREST',	'TXT_KEY_CIV5_IMPROVEMENTS_PLANT_FOREST_HELP',	'TXT_KEY_CIV5_IMPROVEMENTS_PLANT_FOREST_TEXT',	'ART_DEF_IMPROVEMENT_PLANT_FOREST',	'REFOREST_ATLAS',	0 UNION ALL
SELECT 'IMPROVEMENT_PLANT_JUNGLE',	1,						1,				'TXT_KEY_IMPROVEMENT_PLANT_JUNGLE',	'TXT_KEY_CIV5_IMPROVEMENTS_PLANT_JUNGLE_HELP',	'TXT_KEY_CIV5_IMPROVEMENTS_PLANT_JUNGLE_TEXT',	'ART_DEF_IMPROVEMENT_PLANT_FOREST',	'REFOREST_ATLAS',	0;
--------------------------------------------------------------------------------------------------
--Improvement Yields
--------------------------------------------------------------------------------------------------
INSERT INTO Improvement_Yields (ImprovementType,		YieldType,				Yield)
SELECT 'IMPROVEMENT_PLANT_FOREST',						'YIELD_PRODUCTION',		1 UNION ALL
SELECT 'IMPROVEMENT_PLANT_JUNGLE',						'YIELD_FOOD',			1 UNION ALL
SELECT 'IMPROVEMENT_PLANT_JUNGLE',						'YIELD_PRODUCTION',		-1;
...
SELECT 'IMPROVEMENT_PLANT_FOREST',						'TERRAIN_SNOW' UNION ALL
...
SELECT 'IMPROVEMENT_PLANT_FOREST',						'FEATURE_MARSH' UNION ALL
--SELECT 'IMPROVEMENT_PLANT_JUNGLE',						'FEATURE_JUNGLE' UNION ALL
SELECT 'IMPROVEMENT_PLANT_JUNGLE',						'FEATURE_MARSH';

--------------------------------------------------------------------------------------------------
--Improvement Features
--------------------------------------------------------------------------------------------------
INSERT INTO Improvement_Flavors (ImprovementType,		FlavorType,				Flavor)
SELECT 'IMPROVEMENT_PLANT_FOREST',						'FLAVOR_PRODUCTION',	5 UNION ALL
SELECT 'IMPROVEMENT_PLANT_JUNGLE',						'FLAVOR_FOOD',			5;
...
SELECT 'BUILD_FOREST',		'TECH_LOGGING',			900,	'IMPROVEMENT_PLANT_FOREST',	'TXT_KEY_BUILD_FOREST',	'TXT_KEY_BUILD_FOREST_HELP',	'TXT_KEY_BUILD_FOREST_REC',	'ENTITY_EVENT_IRRIGATE',	'KB_F',		37,				'UNIT_ACTION_REFOREST_ATLAS',	0 UNION ALL
SELECT 'BUILD_JUNGLE',		'TECH_FERTILIZER',		1400,	'IMPROVEMENT_PLANT_JUNGLE',	'TXT_KEY_BUILD_JUNGLE',	'TXT_KEY_BUILD_JUNGLE_HELP',	'TXT_KEY_BUILD_JUNGLE_REC',	'ENTITY_EVENT_IRRIGATE',	'KB_J',		37,				'UNIT_ACTION_REFOREST_ATLAS',	0;

--------------------------------------------------------------------------------------------------
--Build Features 
--------------------------------------------------------------------------------------------------
INSERT INTO BuildFeatures (BuildType,	FeatureType,		PrereqTech,				Time,   Production,	Remove)
--SELECT 'BUILD_FOREST',					'FEATURE_FOREST',	'TECH_LOGGING',			900,	40,			1 UNION ALL
SELECT 'BUILD_FOREST',					'FEATURE_MARSH',	'TECH_LOGGING',			900,	0,			1 UNION ALL
--SELECT 'BUILD_JUNGLE',					'FEATURE_JUNGLE',	'TECH_FERTILIZER',		1400,	40,			1 UNION ALL
SELECT 'BUILD_JUNGLE',					'FEATURE_MARSH',	'TECH_FERTILIZER',		1400,	0,			1;
...
BEGIN
	...
	INSERT INTO Unit_Builds (NEW.Type,	'BUILD_JUNGLE')
END;