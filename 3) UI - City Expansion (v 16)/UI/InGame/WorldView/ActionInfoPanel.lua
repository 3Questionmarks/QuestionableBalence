print("This is the modded ActionInfoPanel from 'UI - City Expansion'")
...
function OnEndTurnClicked()
	...
	if (blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_POLICY
		...
		or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_CITY_TILE
...
function OnEndTurnDirty()
	...
	elseif (EndTurnBlockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_CITY_TILE) then
		--print("Choose City Tile");
		strEndTurnMessage = chooseCityTileString;
		strButtonToolTip = chooseCityTileTooltipString;
		buttonDisabled = false;
