...
SELECT		('UNIT_SENSHI_JAHAZI'),		Class, Cost, Range, PrereqTech, 19, RangedCombat, Moves+1, 1, FaithCost,	RequiresFaithPurchaseEnabled, CombatClass, MilitarySupport, MilitaryProduction,	Domain, Pillage, IgnoreBuildingDefense, ObsoleteTech, GoodyHutUpgradeUnitClass, XPValueAttack, XPValueDefense, Conscription,  DefaultUnitAI, ('TXT_KEY_UNIT_SENSHI_JAHAZI'),	('TXT_KEY_CIV5_UNIT_SENSHI_JAHAZI_TEXT'), 	('TXT_KEY_UNIT_SENSHI_JAHAZI_HELP'), 	('TXT_KEY_UNIT_SENSHI_JAHAZI_STRATEGY'),	AdvancedStartCost, 	('ART_DEF_UNIT_SENSHI_JAHAZI'),  0,					('SENSHI_JAHAZI_FLAG'),	2, 				('SENSHI_ZANZIBAR_ATLAS')
...
VALUES		('UNIT_SENSHI_JAHAZI', 	'RESOURCE_HARDWOOD');
--==========================================================================================================================
-- Unit_FreePromotions
--==========================================================================================================================
