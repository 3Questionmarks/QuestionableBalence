print("This is the modded TerrainGenerator from 'Maps - Improved Small Landmasses'")
...
function TerrainGenerator.Create(args)
	...
	local desert_shift = args.desert_shift or 10;
	
	-- Set terrain bands.
	local iDesertPercent = args.iDesertPercent or 15;
	...
	local fTundraLatitude = args.fTundraLatitude or 0.70;
	local fGrassLatitude = args.fGrassLatitude or 0.05; -- Above this is actually the latitude where it stops being all grass. - Bob
	local fDesertBottomLatitude = args.fDesertBottomLatitude or 0.3;
	local fDesertTopLatitude = args.fDesertTopLatitude or 0.45;
